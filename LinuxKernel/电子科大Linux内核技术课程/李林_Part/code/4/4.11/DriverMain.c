...
{
	pgd_t *pgd;
	struct mm_struct *pInitMemStruct;
	int i;
	...
	pInitMemStruct = (struct mm_struct*)kallsyms_lookup_name("init_mm");
	DEBUG_PRINT(DEVICE_NAME " init_mm.pgd = 0x%lx\n", (unsigned long)(pInitMemStruct->pgd));
